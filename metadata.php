...
$aModule = [
    ...
    'templates'      => [
        // Admin
        '@' . Constants::OXID_MODULE_ID . '/admin/contentTabBase.tpl'   => 'views/smarty/admin/contentTabBase.tpl',
        '@' . Constants::OXID_MODULE_ID . '/admin/contentTabs.tpl'   => 'views/smarty/admin/contentTabs.tpl',
        '@' . Constants::OXID_MODULE_ID . '/admin/contentTabList.tpl'   => 'views/smarty/admin/contentTabList.tpl',
        // Frontend
        '@' . Constants::OXID_MODULE_ID . '/d3contenttabs_tab1.tpl'   => 'views/smarty/d3contenttabs_tab1.tpl',
    ],
    'events'         => [
    ...
    'blocks'         => [
        ...
        [
            ...
            'file'     => 'views/smarty/blocks/details_tabs_longdescription.tpl',
        ],
        [
            'template' => 'page/details/inc/tabs.tpl',
            'block'    => 'details_tabs_main',
            'file'     => 'views/smarty/blocks/details_tabs_main.tpl',
        ]
    ],
    'settings' => [
        [
