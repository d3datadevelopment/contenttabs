...
class setupWizard extends d3install_updatebase
{
    ...
    public $sBaseConf = '--------------------------------------------------------------------------------
nvuv2==
--------------------------------------------------------------------------------';
    ...
    protected function completeContentTabsFields(): void
    {
        ...
        $iTabCount = (int) ($settingsService->getString('d3ctextension_amount_tabs', Constants::OXID_MODULE_ID)->toString() ?: '5');

        for ($currentIndex = 2; $currentIndex <= $iTabCount; $currentIndex++) {
            $this->aOldTabDbFields[ 'D3LONGDESC' . $currentIndex ] = [
                'sTableName'  => 'oxartextends',
                'sFieldName'  => 'D3LONGDESC' . $currentIndex, //oxlongdesc2 -> OXLONGDESC2 -> D3LONGDESC2 (Type: TEXT)
                'sType'       => 'TEXT',
                'blNull'      => false,
                'sDefault'    => false,
                'sComment'    => 'D3 ContentTabs',
        ...
        for ($currentIndex = 1; $currentIndex <= $iTabCount; $currentIndex++) {
            $this->aOldTabDbFields['D3LONGDESC'.($currentIndex > 1 ? $currentIndex : '').'TITLE']  = [
                'sTableName'  => 'oxarticles',
                'sFieldName'  => 'D3LONGDESC'.($currentIndex > 1 ? $currentIndex : '').'TITLE', // oxlongdesc2title -> OXLONGDESC2TITLE -> D3LONGDESC2TITLE
                'sType'       => 'varchar(255)',
                'blNull'      => false,
                'sDefault'    => false,
                'sComment'    => 'D3 ContentTabs',
     ...
     */
    public function needToDeleteOldContentTabDatabaseFields(): bool
    {
        $this->completeContentTabsFields();
    ...
    {
        $re = '/(?<=^d3longdesc)\d*(?=title$|$)/mi';
        preg_match($re, $sFieldName, $matches);
        return $matches[0] ?: '1';
    }
