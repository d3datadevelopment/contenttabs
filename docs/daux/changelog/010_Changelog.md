...
## [Unreleased](https://git.d3data.de/D3Private/Contenttabs/compare/5.0.1.0...rel_5.x)

## [5.0.1.0](https://git.d3data.de/D3Private/Contenttabs/compare/5.0.0.0...5.0.1.0) - 2024-07-31
### added
- installierbar in OXID 7.1
### Changed
- Installationprozess migriert die Anzahl der im Modul konfigurierten Langtexte
- Datenbank Schema auf Grund Inkompatibilitäten mit MariaDB angepasst
### fixed
- Tab-Objekt lädt die Anzahl entsprechend der Moduleinstellung
- Moduleinstellungen konnten nicht gespeichert werden

## [5.0.0.0](https://git.d3data.de/D3Private/Contenttabs/compare/4.3.0.0...5.0.0.0) - 2024-01-23
### added
